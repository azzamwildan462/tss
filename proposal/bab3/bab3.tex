...
The primary difference between the two systems is the source of position and orientation data. The legacy system uses GNSS and odometry, while the new system uses camera, LIDAR, and odometry. Additionally, the new system integrates road detection to enhance navigation safety.
...
Figure \ref{fig:ml_capture} shows the raw image captured by the camera. The image is then processed through a series of convolution layers to downsample it.
\begin{figure}[H]
	\centering
